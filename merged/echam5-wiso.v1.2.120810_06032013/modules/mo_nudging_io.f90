...
!EOP
    ...
    IF (lnudgdbx) THEN
       WRITE(mess,*) 'Interpolation between ... steps ',ndgstep1,' ... ',ndgstep2
...
!EOP
    ...
    DO
       ...
       IF (lrd_check) THEN
          ...
          WRITE(mess,*) 'READ NEW nudging DATA, corresponding step is : ',ndgstep3
          CALL message('ReadOneBlock',mess)
...
!BOP
  ...
  SUBROUTINE OpenOneBlock
    ...
    USE mo_nudging_constants, ONLY: linp_div, linp_vor, linp_tem, linp_lnp, lnudgcli
