SUBROUTINE rad_int(                   &
  ...
  ! M. Thomas, MPI, June 2007,  Volcanic aerosols
  ! U. Schlese, MPI, June 2007,  Volcanic aerosols
  ! M. Esch, MPI, June 2007,  Volcanic aerosols
  ...
  INTEGER :: jk, jl, jp, jaer, jb, iaer,ih, jw
