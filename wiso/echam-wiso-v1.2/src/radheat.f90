...
!     S.J. Lorenz, Nov.2007, volcanic forcing (M.A.Thomas)
!
USE mo_kind,              ONLY: dp
...
!   all sky fluxes
       ...
       zflxt1(jl,klevp1)=ztrdown1-cemiss*stbo*ztsnew(jl)**4
       zflxs1(jl,klevp1)=pi0(jl)*ptrsol1(jl,klevp1)
!   clear sky fluxes
       ztrdown01=pemtef01(jl,klevp1)+cemiss*stbo*zti(jl,klevp1)**4
       zflxt01(jl,klevp1)=ztrdown01-cemiss*stbo*ztsnew(jl)**4
