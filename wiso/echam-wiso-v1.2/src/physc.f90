...
USE mo_wiso,              ONLY: nwiso, tnat, calc_delta, cwisomin
...
!  Surface fluxes over land/water/ice - water isotopes
...
REAL(dp) :: wisoevapot(ldc%nproma,nwiso)
...
!---wiso-code
            ...
            , wisoevap(:,:,krow)                                            &
            , zwisoevapl,         zwisoevapw,          zwisoevapi           &
            , wisoevaplac(:,:,krow),wisoevapwac(:,:,krow),wisoevapiac(:,:,krow) &
            , wisosn(:,:,krow),   wisows(:,:,krow),    wisowl(:,:,krow)     &
            , wisosw_d(:,:,krow)                                            &
            , wisoevapot                                                    &
...
!---wiso-code
            ...
            , wisosn(1,1,krow),   wisows(1,1,krow),    wisowl(1,1,krow)     &
            , wisosw_d(1,1,krow)                                            &
            , wisoevapot                                                    &
...
! 
            ...
            , loland,            loglac                               &
!---wiso-code
            , wisows(1,1,krow),    wisowl(1,1,krow),   wisosn(1,1,krow)    &
            , wisosnmel(1,1,krow),wisogld(1,1,krow),   wisosnc(1,1,krow)   &
            , wisorunoff(1,1,krow),wisorogl(1,1,krow), wisodrain(1,1,krow) &
            , wisoapmegl(1,1,krow),wisosnacl(1,1,krow)	                   &
!
            , zwisoevapl,          wisoevapot                              &
            , wisorsfl,            wisorsfc                                &
            , wisossfl,            wisossfc                                &
