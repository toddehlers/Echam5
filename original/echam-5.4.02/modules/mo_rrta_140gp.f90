...
REAL(DP):: ABSA(65,NG1), ABSB(235,NG1)
...
REAL(DP):: ABSA(65,NG2), ABSB(235,NG2)
...
REAL(DP):: ABSA(650,NG3), ABSB(1175,NG3)
...
REAL(DP):: ABSA(585,NG4), ABSB(1410,NG4)
...
REAL(DP):: ABSA(585,NG5),ABSB(1175,NG5)
...
REAL(DP):: ABSA(585,NG7),ABSB(235,NG7)
...
REAL(DP):: ABSA(35,NG8),ABSB(265,NG8)
...
REAL(DP):: ABSA(715,NG9),ABSB(235,NG9)
...
REAL(DP):: ABSA(65,NG10), ABSB(235,NG10)
...
REAL(DP):: ABSA(65,NG11), ABSB(235,NG11)
...
REAL(DP):: ABSA(65,NG14),ABSB(235,NG14)
